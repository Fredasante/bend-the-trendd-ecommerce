        ...
        <div className="max-w-[900px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div className="bg-white shadow-1 rounded-[10px] p-6 sm:p-8 mb-7.5">
            <h2 className="text-xl font-semibold text-dark mb-5 flex items-center gap-2">
              <Package className="w-5 h-5 text-[#007782]" />
              Order Details
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={handlePrint}
              className="flex-1 flex justify-center items-center gap-2 font-medium text-[#007782] bg-white border border-[#007782] py-3 px-6 rounded-md ease-out duration-200 hover:bg-gray-1 print:hidden"
            >
            ...
            <Link
              href="/shop"
              className="flex-1 flex justify-center items-center font-medium text-white bg-[#007782] py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-90 print:hidden"
            >
              Continue Shopping
            </Link>
          </div>
