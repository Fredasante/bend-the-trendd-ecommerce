      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            required
            className="w-full px-4 py-3 border shadow-sm border-gray-300 rounded-lg focus:outline-none focus:border-2 focus:border-pink-600 transition"
          />
          <input
            type="email"
            name="email"
          ...
          <input
            type="text"
            name="interest"
            placeholder="Your interests (e.g., Dresses, Casual wear)"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#382423] text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition disabled:opacity-60"
          >
