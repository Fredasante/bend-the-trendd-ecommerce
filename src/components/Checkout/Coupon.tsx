        ...
        <div className="flex gap-4">
          ...
          {!isApplied ? (
            <button
              ...
              disabled={isLoading}
              className="inline-flex font-medium text-white bg-[#007782] py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
