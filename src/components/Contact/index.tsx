...
const Contact = () => {
  ...
  return (
    <>
      <section className="overflow-hidden py-10 bg-gray-2 mt-33 md:mt-44 md:pb-10 lg:pb-20">
              ...
              <div>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full p-5 outline-none duration-200 focus:border-none"
                  ></textarea>
                </div>
