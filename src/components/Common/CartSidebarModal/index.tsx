...
const CartSidebarModal = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[500px] shadow-1 bg-white relative modal-content flex flex-col h-screen">
        {/* Header */}
        ...
        <div
          ...
          className="flex-1 overflow-y-auto no-scrollbar px-4 sm:px-7.5 lg:px-11 py-7.5"
        >
