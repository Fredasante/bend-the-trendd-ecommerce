    ...
    <div className="group">
      ...
      <div className="w-full flex items-center justify-center gap-2.5 pt-3 pb-2 border-b border-gray-3">
        <button
          ...
          className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-[#382423] flex-shrink-0"
        >
        ...
        <button
          ...
          className="flex items-center justify-center bg-[#382423] font-medium text-custom-sm py-[4px] md:py-[7px] px-1.5 md:px-5 rounded-[5px] text-white ease-out duration-200 hover:bg-opacity-90"
        >
          Add to cart
        </button>
