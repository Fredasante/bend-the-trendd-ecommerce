    ...
    <div className="group">
      ...
      <div className="w-full flex items-center justify-center gap-2.5 pt-3 pb-2 ease-linear duration-200 group-hover:translate-y-0">
        ...
        <button
          ...
          className="inline-flex font-medium text-custom-sm py-[4px] md:py-[7px] px-1.5 md:px-5 rounded-[5px] bg-dark text-white ease-out duration-200 hover:bg-blue-dark"
        >
          Add to cart
        </button>
