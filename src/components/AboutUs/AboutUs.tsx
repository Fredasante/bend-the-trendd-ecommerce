        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div className="flex flex-col xl:flex-row gap-7.5">
            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              ...
              <div className="bg-[#007782]/5 rounded-lg p-6 border-l-4 border-[#007782]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white rounded-xl shadow-1 p-6 text-center">
              <div className="w-16 h-16 bg-[#007782]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 24 24"
